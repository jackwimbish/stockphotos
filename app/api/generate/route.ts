...
const weirdDetails = [
  ...
  "but everyone's shoes are on the wrong feet",
  ...
  "but everyone's glasses have no lenses, just empty frames",
  "but the elevator buttons are all labeled with different types of pasta",
  ...
  "but all the keyboards have keys arranged in alphabetical order",
  "but there's a live peacock perched on someone's shoulder",
  "but everyone's business cards are actually playing cards",
  "but the ceiling is covered in artificial grass",
  "but all the pencils are comically oversized",
  ...
  "but everyone's coffee is clearly just chocolate milk",
  ...
  "but the floor is covered in artificial snow",
  ...
  "but everyone's watches are sundials",
  ...
  "but all the water bottles contain glitter instead of water",
  "but everyone's belts are actually jump ropes",
  "but there's a live jazz band performing on the reception desk",
  "but all the desk chairs are actually exercise balls with wheels",
  "but everyone's lunch is clearly just different colored Play-Doh",
  ...
  "but everyone's smartphones are actually calculators with screens drawn on",
